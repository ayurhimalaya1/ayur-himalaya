            ...
            >
                <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                    ...
                    <button
                        ...
                        className="p-2 -ml-2 text-[#1B3022] md:hidden"
                    ...
                    <Link href="/" className="group flex flex-col items-center md:items-start justify-center absolute left-1/2 -translate-x-1/2 md:static md:translate-x-0">
                    ...
                    {/* Mega-Nav Trigger Area (Desktop Only) */}
                    ...
                    <div className="flex items-center gap-4 md:gap-6">
                        <Link href={isAuthenticated ? "/account" : "/login"} className="hidden md:block font-sans text-sm tracking-widest text-[#2D2D2D] uppercase hover:text-[#D4AF37] transition-colors">
                            {isLoading ? "..." : isAuthenticated ? "Account" : "Login"}
                        </Link>
                        <button
